...
const Navbar = () => {
  ...
  return (
    <>
      ...
      {isMobileMenuOpen && (
        <div className="absolute top-0 right-0 left-0 z-[999]" id="mobile-menu">
          <div
            className="space-y-1 px-2 pb-3 pt-2 h-screen bg-slate-900 opacity-90"
          ...
          >
            ...
            {!session ? (
              ...
              <div
                className="text-blue-200 block px-3 py-2 text-base"
                onClick={() => {
                  signOut({ callbackUrl: "/", redirect: true });
                }}
              >
            ...
            <div className="w-full flex justify-center text-lg text-blue-200 py-4">
              <IoIosCloseCircleOutline size={30} onClick={closeMobileMenu} />
            </div>
